...
/**
 * Initializes RBAC tables with all fixes.
 *
 * @author mrZema
 * @since 2.0.32
 */
class m170531_203800_rbac_init_with_all_fixes extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $this->addForeignKey('{{%fk-auth_assignments-user_id}}', $authManager->assignmentTable, 'user_id', '{{%users}}', 'id', 'CASCADE');
