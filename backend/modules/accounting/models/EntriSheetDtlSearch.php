...
use backend\modules\accounting\models\EntriSheetDtl;

/**
 * EntriSheetDtlSearch represents the model behind the search form about `backend\modules\accounting\models\EntriSheetDtl`.
 */
