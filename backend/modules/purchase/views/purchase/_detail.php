				...
				<tr>
					...
					<td class="items" style="width: 45%">
						<ul class="nav nav-list">
							...
							<li>
								Jumlah <?= Html::activeTextInput($model, "[$index]purch_qty", [
							...
							<li>
								Price Rp <?= Html::activeTextInput($model, "[$index]purch_price", [
					...
					<td class="selling" style="width: 40%">
						<ul class="nav nav-list">
							...
							<li>
								...
								?>
								Markup <?= Html::textInput('', $markup, [
									'data-field' => 'markup_price', 
									'size' => 8, 'id' => false,
									'required'=>true]) ?> %
							</li>
							<li>
								Price Rp <?= Html::activeTextInput($model, "[$index]selling_price", [
