...
/**
 * ProductGroupsSearch represents the model behind the search form about `backend\modules\master\models\ProductGroups`.
 */
class ProductGroupsSearch extends Model
{
    public $id_group;
    public $cd_group;
    public $nm_group;
