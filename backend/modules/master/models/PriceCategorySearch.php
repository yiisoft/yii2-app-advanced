...
use backend\modules\master\models\PriceCategory;

/**
 * PriceCategorySearch represents the model behind the search form about `backend\modules\master\models\PriceCategory`.
 */
