...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'This generator generates an migration class for the specified database.';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['db', 'tableName','migrationName'], 'filter', 'filter' => 'trim'],
            [['migrationPath'], 'filter','filter'=>function($value){return rtrim($value, '/');}],

            [['db','migrationName','migrationPath'], 'required'],
    ...
    {
        return array_merge(parent::stickyAttributes(), ['migrationPath', 'db', 'generateRelations']);
    }
