...
class Hooks
{
    ...
    const E_TNCRE_1 = 'eTNCre1';
    const E_TNCRE_21 = 'eTNCre21';
    const E_TNCRE_22 = 'eTNCre22';
    const E_TNCRE_23 = 'eTNCre23';
    
    const E_INAPP_1 = 'eINApp1';
    const E_INAPP_21 = 'eINApp21';
    const E_INAPP_22 = 'eINApp22';
    const E_INAPP_23 = 'eINApp23';
}